...
public final class HotkeyController {
    ...
    public func configure(_ bindings: [ShortcutBinding]) -> [HotkeyAction: HotkeyRegistrationStatus] {
        ...
        if handler == nil {
            ...
            let status = InstallEventHandler(GetApplicationEventTarget(), freelyHotkeyHandler, 1, &eventType,
                                            context, &handler)
...
private let freelyHotkeyHandler: EventHandlerUPP = { _, event, userData in
